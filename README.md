...
**Agentic AI & ML Engineer · From $1B+ Freight Networks to State Government AI · GenAI · Supply Chain Intelligence**
...
![FAISS](https://img.shields.io/badge/FAISS-0081CB?style=flat-square)
...
$400K saved via predictive maintenance @ BNSF Railway   → 500+ locomotives
 70%  reduction in cybersecurity triage time @ NM DOIT  → CIO Recognition
 99%  recall on 18,700+ compliance entities             → SentinelRAG
 94%  recall on 590K+ fraud transactions                → Risk Platform
MAPE  < 8% on 46M+ demand records                      → Supply Chain Orchestrator
```

---

*Open to collaborations on Agentic AI, ML Engineering, and Supply Chain Intelligence projects.*
